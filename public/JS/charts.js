document.addEventListener('DOMContentLoaded', function() {
    ...
    // ==========================================
    const stepCtx = document.getElementById('stepTrajectoryChart').getContext('2d');
    ...
    // ==========================================
    const intensityCtx = document.getElementById('highIntensityChart').getContext('2d');
    ...
    btnDaily.addEventListener('click', () => {
        ...
        // Mock Daily Data
        stepValueElement.innerHTML = `12,482 <span class="fs-6 font-normal text-on-surface-variant">/day</span>`;
        ...
        intensityValueElement.innerHTML = `45 <span class="fs-6 font-normal text-on-surface-variant">min</span>`;
        ...
        // Calories Mock Data
        caloriesValueElement.innerHTML = `<span class="text-primary-container">2,450</span> IN <span class="text-on-surface-variant fs-4 px-2">/</span> <span class="text-tertiary">2,800</span> OUT`;
    ...
    btnWeekly.addEventListener('click', () => {
        ...
        stepValueElement.innerHTML = `84,200 <span class="fs-6 font-normal text-on-surface-variant">/wk</span>`;
        stepChart.data.labels = stepLabelsWeekly;
        stepChart.data.datasets[0].data = stepDataWeekly;
        stepChart.data.datasets[0].pointRadius = (ctx) => ctx.dataIndex === 5 ? 6 : 0;
        stepChart.update();

        intensityValueElement.innerHTML = `320 <span class="fs-6 font-normal text-on-surface-variant">min</span>`;
        ...
        // Calories Mock Data
        caloriesValueElement.innerHTML = `<span class="text-primary-container">16,550</span> IN <span class="text-on-surface-variant fs-4 px-2">/</span> <span class="text-tertiary">18,000</span> OUT`;
    ...
    btnMonthly.addEventListener('click', () => {
        ...
        // Mock Monthly Data
        stepValueElement.innerHTML = `324,500 <span class="fs-6 font-normal text-on-surface-variant">/mo</span>`;
        ...
        intensityValueElement.innerHTML = `1,280 <span class="fs-6 font-normal text-on-surface-variant">min</span>`;
        ...
        // Calories Mock Data
        caloriesValueElement.innerHTML = `<span class="text-primary-container">72,000</span> IN <span class="text-on-surface-variant fs-4 px-2">/</span> <span class="text-tertiary">78,500</span> OUT`;
